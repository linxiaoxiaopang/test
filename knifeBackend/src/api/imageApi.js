...
export function publicUpdate(id, data) {
  return request({
    url: '/api/image/public_image/' + id + '/',
    method: 'patch',
    data
  })
}

export function changePublicUpdate(id, data) {
  return request({
    url: '/api/image/public_image/' + id + '/change_images',
    method: 'patch',
    data
  })
}
...
export function publicCheck(data) {
  return request({
    url: '/api/image/public_image/check_img',
    method: 'post',
    data
  })
}
