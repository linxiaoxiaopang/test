<template>
  <div class="app-container">
    <eHeader :query="query" v-p="['rbac:roles:create']"/>
    <el-row :gutter="28">
      <el-col :span="span">
        <!--表格渲染-->
        <el-table
        ...
        >
          ...
          <el-table-column label="操作" align="center" width="100px">
            <template slot-scope="scope">
              <edit :data="scope.row" :sup_this="sup_this" v-p="['rbac:roles:partial_update']" />
      ...
      <el-col :span="8">
        <el-card v-if="show" class="role-page-box-card">
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      ...
      if (this.row_data) {
        ...
        this.$nextTick(() => {
          this.menuIds =
            this.row_data.menus &&
            this.row_data.menus.filter((key) => {
    ...
    getPermissions() {
      if (
        Array.isArray(this.permission_list) &&
        this.permission_list.length === 0
      ) {
